...
import { HistoryEntry, useSidekickHistorySearch } from "./browserHistory"
...
export default function Command(): ReactElement {
    ...
    const { isLoading, error, entries } = useSidekickHistorySearch(searchText)
...
function TabListItemActions(props: { tab: Tab }) {
  return (
    <ActionPanel title={props.tab.title}>
      <SidekickGoToTab tab={props.tab} />
      <CopyToClipboardAction title="Copy URL" content={props.tab.url} />
    </ActionPanel>
  );
}

function SidekickGoToTab(props: { tab: Tab }) {
